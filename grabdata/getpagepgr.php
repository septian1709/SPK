...
include("koneksi.php");
	...
	$parameter2="Info Gempa Mag:0 SR,, Lok: , ), Kedlmn: Km ::BMKG-PGR III";
	...
	//print_r($cutwaktu2);
	$cek=mysqli_query($koneksi,"SELECT * FROM repository WHERE idpublic = '$publicid1'");
	if ($parameter1!=$parameter2 && mysqli_num_rows($cek) == 0){
	...
	('$id', '$publicid1', '$parameter1', '$kode[1]', '$RMS1', '$GAP1', '$FASE1', '$cutwaktu21', '$cutwaktu21'
	,'$mag', '$latpgr', '$cut2221[4]', '-$cut3331[2]', '$cut231')");
	}
