    ...
    <div class="container-fluid">
	  ...
	  <div class="container">
	   <div class="form-group" >
		...
		<div class="form-group">
		<textarea type="text" name="gempa"  placeholder="isi dengan data gempabumi" class="form-control" autofocus></textarea>
		</div>
		...
		<div class="col-6">
		<input type="text" name="judul"  placeholder="isi nama kota untuk judul" class="form-control" />
		</div>
		</div>
		<div class="form-group row">
		<div class="col-2">
		<label class="checkbox-inline"><input type="checkbox" name = "sig1" value="I SIG (I-II MMI)">	 I SIG</label>
		</div>
		<div class="col-10">
		...
		<div class="form-group row">
		<div class="col-2">
		<label class="checkbox-inline"><input type="checkbox" name = "sig2" value="II SIG (III-V MMI)">	 II SIG</label>
		</div>
		<div class="col-10">
...
<div class="form-group row">
<div class="col-8">
<button class="btn btn-block btn btn-primary" type="button" data-toggle="modal" data-target="#peringatan">Proses</button>
<div class="modal fade" id="peringatan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">Pastikan sumber gempabuminya sudah benar sesuai kedalaman.
		Jika sudah ceklist pada data SIG maka kota harus diisi, begitu sebaliknya. Selanjutnya cek kembali
		EYD untuk kota.
		  </div>
...
<div class="col-4">
<input type="submit" name="Save" value="Simpan" class="btn btn-block btn btn-primary">
</br>    
</div>  
</div> 
</div> 
