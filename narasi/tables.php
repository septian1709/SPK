			...
			<form class="form-inline " method="get">
				<div class="form-group mx-sm-3 mb-3">
					...
					<?php $filter_stasiun = (isset($_GET['filter_stasiun']) ? strtolower($_GET['filter_stasiun']) : NULL);  ?>
						<option value="Filter Stasiun"<?php if($filter_stasiun=="Filter Stasiun"){ echo 'selected'; } ?>>Filter Stasiun</option>
			...
			<br />	
			   ...
			   <?php
					if($filter_nama){
						...
						$sql = mysqli_query($koneksi, "SELECT * FROM tb_narasi"); // jika tidak ada filter maka tampilkan semua entri
					}
