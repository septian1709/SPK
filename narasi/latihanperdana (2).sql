...
--
-- Table structure for table `dataambil`
--

CREATE TABLE `dataambil` (
...
INSERT INTO `dataresume` (`id`, `idpublic`, `gempabumi`, `RMS`, `GAP`, `FASE`, `TIME`, `TIME2`, `SKOR`, `STATUS`) VALUES
('PGR III', 'bmg2018jzvr\n', 'Info Gempa Mag:3.3 SR, 23-May-18 12:10:26 WIB, Lok:8.67 LS,118.40 BT (16 km Tenggara DOMPU-NTB), Kedlmn:104 Km ::BMKG-PGR III', '0.54', '130', '10', '12:10:26', '2018-05-23 07:44:05', 698, '1'),
('BMKG SANGLAH', 'BMKG2018jzvr\n', 'Info Gempa Mag:2.8 SR, 23-May-18 12:10:25 WIB, Lok:8.73 LS,118.43 BT (24 km Tenggara DOMPU-NTB), Kedlmn:104 Km ::BMKG-DNP', '0.53', '171', '7', '12:10:25', '2018-05-23 07:44:05', 631, '');
...
--
-- Dumping data for table `tb_beritacuaca`
--
...
--
-- Dumping data for table `tb_latlong`
--
...
--
-- Table structure for table `tb_narasi`
--
...
--
-- Dumping data for table `tb_narasi`
--
...
(84, '13 April 2018', '15:22:30', '8.81', '118.37', '4.9', '113', ' 30 km Tenggara Dompu NTB', 'BMKG-PGR III', 'Tes Narasi I SIG (II MMI)', 'bima1meiSIG.jpg', 'bima1mei.jpg', '', 'pande', ''),
(85, '22 Mei 2018', '18:01:43', '9.02', '115.63', '4.8', '91', ' 33 km Tenggara Klungkung BALI', 'BMKG-PGR III', 'Karangasem dan Jimbaran (I SIG (II MMI)),\r\n			Denpasar, Mataram, dan Kuta (II SIG (III MMI))', '22Mei2018SIGBALI.jpg', '22Mei2018MMIBALI.jpg', 'Aktif', 'sabun', ''),
(88, ' Desember 20', '00::', '0.00', '0.00', '0.0', '', '    ', '', ' ', '', '', '', '', '');
...
--
-- Table structure for table `tb_penjelasan`
--
...
--
-- Dumping data for table `tb_penjelasan`
--
...
INSERT INTO `tb_spk` (`parameter`) VALUES
('  Gempa Mag:, 21-May-18 21:16:03 WIB,Lok: 9.40 LS - 125.37 BT (53 km TimurLaut MALAKA-NTT), Kedlmn: 10 Km '),
('  Gempa Mag:, 21-May-18 21:16:03 WIB,Lok: 9.40 LS - 125.37 BT (53 km TimurLaut MALAKA-NTT), Kedlmn: 10 Km '),
('  Gempa Mag:, 21-May-18 21:16:03 WIB,Lok: 9.40 LS - 125.37 BT (53 km TimurLaut MALAKA-NTT), Kedlmn: 10 Km '),
(''),
(''),
...
--
-- Indexes for table `dataambil`
--
ALTER TABLE `dataambil`
